        ...
        <div class="box">
            <form id="insert" name="insert" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"
                ...
                <div class="row gtr-50 gtr-uniform">
                    ...
                    <div class="">
                        <input class="form-check-input" type="radio" name="membership" value="basic" /> <label for="basic">Basic Membership: $19.99/month, with 5 calls a month</label><br>
                        <input class="form-check-input" type="radio" name="membership" value="premium"/> <label for="premium">Premium Membership: $49.99/month, with unlimited calls a month</label>
                    </div>
